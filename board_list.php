...
$sSql = " select count(*) as scnt from board " . $sqry;
...
<section>
  ...
  <form method="post" action="board_list.php" style="float:right">
	  	<div class="input-group mt-3 mb-3" >
		  <div class="input-group-prepend">
		    <select class="btn btn-outline-secondary dropdown-toggle" name="keyfield" data-toggle="dropdown">
		      <option class="dropdown-item" value="id">Search ID</option>
...
$con = mysqli_connect("localhost", "root", "", "test");
$sql = "select * from board " . $sqry . " order by num desc";
...
if ($total_page >= 2 && $page >= 2) {
  $new_page = $page - 1;
  echo "
  <li><a href='board_list.php?page=$new_page'>◀ 이전</a> </li>";
} else {
  echo "<li>&nbsp;</li>";
}
