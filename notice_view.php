...
?>		
      ...
      echo "▷ 첨부파일 : $file_name ($file_size Byte) &nbsp;&nbsp;&nbsp;&nbsp;
	    ...
	    <ul class="buttons">
				<li><button class="btn btn-primary" style="color:white;" onclick="location.href='notice_list.php?page=<?= $page ?>'">목록</button></li>
				<?php if ($userid == "admin") { ?>
				<li><button class="btn btn-primary" style="color:white;" onclick="location.href='notice_modify_form.php?num=<?= $num ?>&page=<?= $page ?>'">수정</button></li>
				<li><button class="btn btn-primary" style="color:white;" onclick="location.href='notice_form.php'">글쓰기</button></li>
