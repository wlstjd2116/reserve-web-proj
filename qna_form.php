	    ...
	    <form  name="qna_form" method="post" action="qna_insert.php" enctype="multipart/form-data">
	    	 <ul id="board_form">
	    		...
	    		<li>
	    			...
	    			<span class="col2"><input name="subject" class="form-control" type="text"></span>
	    		</li>	    	
	    		<li id="text_area">	
	    	...
	    	<ul class="buttons">
				...
				<li><button class="btn btn-primary" style="color:white;" type="button" onclick="location.href='qna_list.php'">목록</button></li>
			</ul>
	    </form>
	</div> <!-- board_box -->
</section> 
